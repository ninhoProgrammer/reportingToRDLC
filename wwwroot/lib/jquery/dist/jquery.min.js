...
$(document).ready(function () {
    // Solo ejecuta el script si el contenedor está presente
    $('#peAnio').change(function () {
        var peAnio = $(this).val();
        //console.log('Año seleccionado:', peAnio);
        ...
        if (peAnio) {
            $.getJSON('/Home/GetPeTipos', { peAnio: peAnio }, function (data) {
    ...
    $('#peTipo').change(function () {
        var peTipo = $(this).val();
        var peAnio = $('#peAnio').val(); // Obtén el Año seleccionado

        $('#teNumeroPeriodo').empty().append('<option value="">NUMERO</option>').prop('disabled', true);

        if (peTipo) {
            $.getJSON('/Home/GetTeNumeroPeriodos', { peAnio: peAnio, peTipo: peTipo  }, function (data) {
    ...
    $('#rowSelect').on('click', '.select-row', function () {
        // Elimina la clase de fila seleccionada de todas las filas
        $('#example tbody tr').removeClass('selected-row');
        ...
        console.log('Año seleccionado:', selectedData[1]);
        if (peTipo) {
            $.getJSON('/Home/createreports', { ReCodigo: selectedData[0], ReNombre: selectedData[1], peAnio: peAnio, peTipo: peTipo, peNumero: peNumero }, function (data) {
